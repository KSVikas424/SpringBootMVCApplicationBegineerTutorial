...
public class SpringBootMvcApplicationBeginnerTutorialApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringBootMvcApplicationBeginnerTutorialApplication.class, args);
    }
